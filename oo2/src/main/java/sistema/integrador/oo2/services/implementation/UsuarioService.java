...
import sistema.integrador.oo2.converters.UsuarioConverters;
...
import sistema.integrador.oo2.repositories.IUsuarioRepository;
...
public class UsuarioService implements IUsuarioService, UserDetailsService{
	...
	private UsuarioConverters usuarioConverter;
	...
	public UsuarioModel insertOrUpdate(UsuarioModel usuarioModel) {
		usuarioModel.setContraseña(encoder.encode(usuarioModel.getContraseña()));
	...
	private User buildUser(Usuario usuario, List<GrantedAuthority> grantedAuthorities) {
		return new User(usuario.getNombreDeUsuario(), usuario.getContraseña(), usuario.isEnabled(),
